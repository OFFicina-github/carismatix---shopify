...
if (par_specifiche_tecniche) {
  ...
  const pezziStringa = par_specifiche_tecniche.textContent.split(/,\s| e /);

  pezziStringa.forEach(function(pezzo) {
    const elementoP = document.createElement('p');
    elementoP.classList.add('lista_specifiche_tecniche');
    elementoP.textContent = pezzo;
    par_specifiche_tecniche.parentNode.insertBefore(elementoP, par_specifiche_tecniche.nextSibling);
  });
