...
setTimeout(function(){
    if (document.querySelector('.thpb_combo_wflex .thpb_combo_title .thpb_combo_wflex') && document.querySelector('.thpb_combo_wflex .thpb_combo_title .thpb_combo_wflex').textContent.includes('Questo KIT contiene')) {
